...
sudo chown panda:panda /usr/local/bin/greenbone-nvt-sync;
sudo runuser -l panda -c 'whoami';
sudo rm /opt/gvm/var/run/feed-update.lock;
runuser -l panda -c 'greenbone-nvt-sync';
